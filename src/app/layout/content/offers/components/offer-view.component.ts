...
@Component({
  selector: "skrambler-offer-view",
  templateUrl: "../templates/view.component.html",
  styleUrls: ["../styles/offer-form.component.scss"],
})
export class OfferViewComponent extends SkramblerFormBaseComponent implements OnInit, FormInterface {
  ...
  ngOnInit() {
    ...
    this.subscription$ = this._activatedRoute.data.subscribe(
      (response: {
        ...
        tags: any[]
        brand?: { categories: Category[], brand: Offer }
      }) => {
 ...
 */
  ...
  */
  ...
  addFormValidations(): void {
    ...
    this.addFormControlWithValidations("max_allowed_offers",[]);
  }
