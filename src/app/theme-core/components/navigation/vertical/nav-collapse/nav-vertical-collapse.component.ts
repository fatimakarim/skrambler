...
@Component({
    selector   : 'skrambler-nav-vertical-collapse',
...
export class SkramblerNavVerticalCollapseComponent implements OnInit
{
    @Input() item: any;
    ...
    constructor(
        private navigationService: SkramblerNavigationService,
