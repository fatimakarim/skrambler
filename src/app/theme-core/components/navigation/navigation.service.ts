...
import {SkramblerNavigationModelInterface} from "./navigation.model";
...
export class SkramblerNavigationService {
    ...
    updateNavigationModel() {
        this.navigationModel = new SkramblerNavigationModel(this.permissionService);
        this.onNavigationModelChange.next(this.navigationModel.model);
    }

    isNavigationModelAlreadySet() {
